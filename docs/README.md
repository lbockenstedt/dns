...
- [dns.md](dns.md) — this module's feature reference (purpose, ports, env vars, install flags, commands, gotchas).
...
The **full canonical doc set** (all modules, the env-var reference, the install-flag reference, and the hub/WebUI/generic-agent pages) lives in [`lm/docs/`](../../lm/docs/README.md) — specifically [`lm/docs/dns.md`](../../lm/docs/dns.md).
